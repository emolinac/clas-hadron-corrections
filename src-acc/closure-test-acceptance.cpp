...
int main(int argc, char* argv[])
{
    ...
    for(int Pt2_bin = 0 ; Pt2_bin < N_Pt2 ; Pt2_bin++)
    {
        ...
        fresult->cd();
        hacc->Write(get_accf_histo_name(sim_target_index,Q2_bin,Nu_bin,Zh_bin,Pt2_bin).c_str());
        hdat->Write(get_data_histo_name(sim_target_index,Q2_bin,Nu_bin,Zh_bin,Pt2_bin).c_str());
        href->Write(("ref_"+get_acccorr_histo_name(sim_target_index,Q2_bin,Nu_bin,Zh_bin,Pt2_bin)).c_str());
