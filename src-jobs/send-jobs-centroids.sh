    ...
    do
        ...
        do
            ...
            sbatch --job-name=cntr_${data_target}${vertex_cut} \
                   --error=${main_dir}/err/cntr-${data_target}${vertex_cut}_${Q2_bin}${Nu_bin}${Zh_bin} \
                   --output=${main_dir}/out/cntr-${data_target}${vertex_cut}_${Q2_bin}${Nu_bin}${Zh_bin} \
                   ./job-centroids.sh ${data_target} ${vertex_cut} ${Q2_bin} ${Nu_bin} ${Zh_bin}
        done
    done
done
