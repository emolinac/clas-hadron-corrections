...
all: ${BIN}/acceptance ${BIN}/closure-test-ntuples ${BIN}/closure-test-acceptance ${BIN}/centroids ${BIN}/fit-phipq ${BIN}/apply-rad ${BIN}/get-rc
...
${BIN}/closure-test-acceptance: ${SRC_ACC}/closure-test-acceptance.cpp
	${CXX} ${ROOTCFLAGS} ${SRC_ACC}/closure-test-acceptance.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/closure-test-acceptance
